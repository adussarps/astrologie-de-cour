...
// L'orbe est propre à chaque planète : c'est l'étendue de son influence —
// « la distance dans laquelle elle peut en arrêter une autre qui s'applique à
// la conjonction ou à l'aspect » (al-Bīrūnī, Tafhīm, §436). Deux planètes se
// voient quand leur écart à l'aspect exact n'excède pas la moyenne de leurs
// deux orbes, c'est-à-dire la somme de leurs moitiés d'orbe. Al-Bīrūnī
// rapporte cette règle au §490, parmi d'autres limites concurrentes (5°, 6°,
// 12°, 15°, ou la seule conjonction exacte) ; c'est celle que la tradition
// latine a retenue — Lilly : « dans la moitié de leurs orbes à toutes deux ».
export const ORBES = {
  source: 'Al-Bīrūnī, Tafhīm, §436 (les orbes) et §490 (la moyenne des deux)',
  table: {
...
export const RESERVES = [
  {
    ...
    texte: 'Le site ne la calcule pas. Ptolémée et al-Qabīṣī ne désignent pas de la même façon le hyleg — le point d’où l’on fait partir la vie —, et le nombre dépendrait ensuite de l’état de la planète qui donne les années, puis des regards qui ajoutent et retranchent. C’est là que la règle cesse d’être une règle : un chiffre aurait dit quel livre était ouvert, non l’âge du natif.',
  },
  {
